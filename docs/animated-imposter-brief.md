...
Status: OPEN — to be answered by a fresh agent before any new baker code is written.
...
This doc is the briefing for a research pass, not a plan. Do not write baker code until the path is chosen and validated here.
