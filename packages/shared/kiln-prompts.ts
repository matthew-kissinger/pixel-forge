 ...
 *
 * Single source of truth for all Kiln prompt content.
 * Used by both the server (claude.ts) and client (kiln/prompt.ts).
 */
...
export type { RenderMode, AssetCategory, AssetStyle };
